...
- Office hours: 
	- Rider Foley: Monday 2-4pm in Thornton A218
...
- Assignments A-D: 50%
- Assignment E (In-class participation): 10%
- Assignment F (Homework): 10%
- Assignment G (In-Class activities): 10%
- Assignment H (Final Presentation): 20%
...
- **A. Explore a CPS Dataset**: Working in teams, you will use the existing data streams from a real-world test-bed to prototype an application.
...
- **C. Discussions on Ethics Topics**: You will participate in online discussions on IEEE EAD, responsible innovation, and technology risks.
- **D. Ehtics Flash Talks**: You will present on an ethics topic, which may draw from earlier discussion posts, in-class discussions, and analysis.
- **E. Participation**: This course can be truly transformational in your course of study here at SEAS. However, the level of benefit you will receive is directly proportional to your level of engagement and effort. Active participation is therefore essential to getting the most out of the course. As CPS engineers work in groups, you will need to apply all that we will teach you about group work to ensure that your groups are high-functioning groups.
- **F. Homework**: Technical lectures will be accompanied by a homework assignment to be done individually.
- **G. In-Class Activities**:  Paper reading, ethics presentations, peer-review, and final project application design.
- **H. Final Presentation**: Your team will present the motivation, technical details, social, ethical, and policy implications, and results of a proposed cyber-physical system. The final will provide an opportunity to highlight you new integrated understanding of CPS projects and the different kinds of expertise required of a CPS engineer.
...
| Dates | Type | Topic | Notes |
|:---:|:---:|:---:|:---:|
| Tue 08/25 |  | Courses begin |  |
| Wed 08/26 | Joint | Introduction |  |
| Mon 08/31 | Joint | Thoughtful questions |  |
| Wed 09/02 | Joint | Guest lecture |  |
| Mon 09/07 | Ethics | User-based design	 |  |
| Wed 09/09 | Tech | Guest lecture	 |  |
| Mon 09/14 | Ethics | IEEE EAD 1 |  |
| Wed 09/16 | Tech | Cloud |  |
| Mon 09/21 | Ethics | Algorithmic Accountability in the Making |  |
| Wed 09/23 | Tech | Gateway |  |
| Mon 09/28 | Ethics | IEEE EAD 2 |  |
| Wed 09/30 | Tech | Embedded system |  |
| Mon 10/05 |  | No class | Fall break |
| Wed 10/07 | Tech | Wireless communication |  |
| Mon 10/12 | Ethics | IEEE EAD 3 |  |
| Wed 10/14 | Joint | Project review |  |
| Mon 10/19 | Ethics | Responsible innovation 1 |  |
| Wed 10/21 | Tech | Wireless networking |  |
| Mon 10/26 | Ethics | Responsible innovation 2 |  |
| Wed 10/28 |  | No class |  |
| Mon 11/02 | Ethics | Emerging policies and issues |  |
| Wed 11/04 | Tech | Technical writing and speaking |  |
| Mon 11/09 | Ethics | Privacy, transparency, and trust |  |
| Wed 11/11 | Tech | Security and privacy |  |
| Mon 11/16 | Ethics | Guest lecture |  |
| Wed 11/18 | Tech | Applications - papers |  |
| Mon 11/23 | Joint | Project review |  |
| Wed 11/25 |  | No class | Thanksgiving |
| Mon 11/30 | Joint | Project workshop |  |
| Wed 12/02 | Joint | Ethics flash talks |  |
| Mon 12/07 | Joint | Project critique |  |
| Fri 12/08 |  | Courses end |  |
| TBD | Joint | Presentations - Exam |  |
