...
- **A. Develop an Application using a test-bed data source**: Working in teams, you will use the existing data streams from a real-world test-bed to prototype an application.
...
- **G. Participation**: This course can be truly transformational in your course of study here at SEAS. However, the level of benefit you will receive is directly proportional to your level of engagement and effort. Active participation is therefore essential to getting the most out of the course. As CPS engineers work in groups, you will need to apply all that we will teach you about group work to ensure that your groups are high-functioning groups.
- **H. Homework**: Technical lectures will be accompanied by a homework assignment to be done individually.
- **I. In-Class Assignments**:  Paper reading, ethics presentations, peer-review, and final project application design.
...
| Wed 09/02 | Joint | Guest lecture - Smart health |  |
| Mon 09/07 | Joint | Guest lecture - Smart health |  |
| Wed 09/09 | Tech | Cloud |  |
| Mon 09/14 | Ethics | IEEE EAD 1 |  |
| Wed 09/16 | Tech | Gateway |  |
| Mon 09/21 | Ethics | IEEE EAD 2 |  |
| Wed 09/23 | Tech | Embedded system |  |
| Mon 09/28 | Ethics | IEEE EAD 3 |  |
| Wed 09/30 | Tech | Wireless communication |  |
| Mon 10/05 |  | No class | Fall break |
| Wed 10/07 | Tech | Wireless networking |  |
| Mon 10/12 | Ethics | Responsible innovation 1 |  |
| Wed 10/14 | Joint | Project review |  |
| Mon 10/19 | Ethics | Responsible innovation 2 |  |
| Wed 10/21 |  | No class | Link Lab Research Day |
| Mon 10/26 | Ethics | Emerging policies and issues |  |
| Wed 10/28 | Tech | Technical writing and speaking |  |
| Mon 11/02 | Ethics | Privacy, transparency, and trust |  |
| Wed 11/04 | Tech | Applications - papers |  |
| Mon 11/09 | Ethics | Cybersecurity |  |
| Wed 11/11 | Tech |  Sensors and actuators |  |
| Mon 11/16 | Ethics | Guest lecture |  |
| Wed 11/18 | Tech | Security and privacy |  |
